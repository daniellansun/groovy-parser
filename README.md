# groovy-parser(project code: parrot)
...
Currently almost all features of Groovy are available, the parser is being testing. After all test cases passes, some new features will be added(e.g. do-while loop, identical operation`===`, lambda expression, etc)

If you want to give it a try, make sure your machine have `JDK 8+` installed and follow the steps:
