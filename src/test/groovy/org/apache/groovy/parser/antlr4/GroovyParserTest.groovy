...
class GroovyParserTest extends GroovyTestCase {
    ...
    void "test groovy core - Map"() {
        ...
        TestUtils.doRunAndTest('core/Map_02x.groovy');
    }
    ...
    void "test groovy core - Assert"() {
        ...
        TestUtils.doRunAndTest('core/Assert_04x.groovy');
    }
    ...
    */
    ...
    void "test groovy core - FieldDeclaration"() {
        TestUtils.doRunAndTest('core/FieldDeclaration_01x.groovy');
    }

    void "test groovy core - Number"() {
        TestUtils.doRunAndTest('core/Number_01x.groovy');
    }
    ...
    void "test groovy core - BUG"() {
        ...
        TestUtils.doTest('bugs/BUG-GROOVY-8161.groovy');

        TestUtils.doRunAndTest('bugs/GROOVY-3898.groovy');
        TestUtils.doRunAndTest('bugs/GROOVY-8228.groovy');

        TestUtils.doRunAndTest('bugs/BUG-GROOVY-8311.groovy');
    }
}
