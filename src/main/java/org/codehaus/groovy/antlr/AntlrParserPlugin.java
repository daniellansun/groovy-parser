...
import org.codehaus.groovy.syntax.LegacyNumbers;
...
public class AntlrParserPlugin extends ASTHelper implements ParserPlugin, GroovyTokenTypes {
    ...
    protected Expression unaryMinusExpression(AST unaryMinusExpr) {
        ...
        switch (node.getType()) {
            ...
            case NUM_INT:
            case NUM_LONG:
                ConstantExpression constantLongExpression = new ConstantExpression(LegacyNumbers.parseInteger(unaryMinusExpr,"-" + text));
    ...
    protected ConstantExpression integerExpression(AST node) {
        String text = node.getText();
        Object number = LegacyNumbers.parseInteger(node, text);
