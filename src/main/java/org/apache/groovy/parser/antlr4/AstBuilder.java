...
//                .filter(e -> e instanceof Statement)
    ...
    public Statement visitTryCatchStatement(TryCatchStatementContext ctx) {
        ...
        return this.transformTryCatchStatement(this.configureAST(tryCatchStatement, ctx));
    }
    ...
    private ExpressionStatement makeVariableDeclarationFinal(ExpressionStatement variableDeclaration) {
        ...
        if (!(declarationExpression.getLeftExpression() instanceof VariableExpression)) {
            throw createParsingFailedException("The expression statement is not a variable delcaration statement", variableDeclaration);
        }
     ...
     */
    private Statement transformTryCatchStatement(TryCatchStatement tryCatchStatement) {
    ...
    private Statement transformBasicTryWithResourcesStatement(TryCatchStatement tryCatchStatement) {
        ...
        this.appendStatementsToBlockStatement(blockStatement, firstResourceStatement);
        ...
        this.appendStatementsToBlockStatement(blockStatement, primaryExcDeclarationStatement);
    ...
    private CatchStatement createCatchBlockForOuterNewTryCatchStatement(String primaryExcName) {
        ...
        this.appendStatementsToBlockStatement(blockStatement, primaryExcAssignStatement);

        // throw #t;
        ThrowStatement throwTExcStatement = new ThrowStatement(new VariableExpression(tExcName));
        this.appendStatementsToBlockStatement(blockStatement, throwTExcStatement);
    ...
    private BlockStatement createFinallyBlockForNewTryCatchStatement(String primaryExcName, String firstResourceIdentifierName) {
        ...
        TryCatchStatement newTryCatchStatement =
                new TryCatchStatement(
                        this.createBlockStatement(this.createCloseResourceStatement(firstResourceIdentifierName)), // { Identifier?.close(); }
                        EmptyStatement.INSTANCE);
        ...
        newTryCatchStatement.addCatch(
                ...
                new CatchStatement(
                        ...
                        this.createBlockStatement(this.createAddSuppressedStatement(primaryExcName, suppressedExcName)) // #primaryExc.addSuppressed(#suppressedExc);
                )
        );
        ...
        this.appendStatementsToBlockStatement(finallyBlock, ifStatement);

        return this.createBlockStatement(finallyBlock);
    }
