...
import static org.apache.groovy.parser.antlr4.GroovyParser.AssertStmtAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.BreakStmtAltContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.BuiltInTypeContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.BuiltInTypePrmrAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.ClassifiedModifiersContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.ClosureContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.ClosurePrmrAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.ConditionalStmtAltContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.ContinueStatementContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.ContinueStmtAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.DimsContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.DimsOptContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.EnhancedArgumentListContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.ExpressionStmtAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.GstringPrmrAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.ImportStmtAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.LambdaPrmrAltContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.ListContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.ListPrmrAltContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.LiteralPrmrAltContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.LocalVariableDeclarationContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.LocalVariableDeclarationStmtAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.MapPrmrAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.MethodDeclarationStmtAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.NormalExprAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.ParenPrmrAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.StatementsContext;
import static org.apache.groovy.parser.antlr4.GroovyParser.StringLiteralAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.TryCatchStmtAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.TypeDeclarationStmtAltContext;
...
import static org.apache.groovy.parser.antlr4.GroovyParser.VariableInitializersContext;
...
// } type       --------------------------------------------------------------------
    ...
    public Object visit(ParseTree tree) {
        ...
        if (null == interceptor) {
            ...
            result = interceptor.intercept(tree, super::visit);
        }

        return result;
    }

    private VisitingInterceptor interceptor;
    public void registerInterceptor(VisitingInterceptor interceptor) {
        if (null == this.interceptor) {
            this.interceptor = interceptor;
            return;
        }

        VisitingInterceptor visitingInterceptorToChain = this.interceptor;
        for (; null != visitingInterceptorToChain.getVisitingInterceptor(); visitingInterceptorToChain = visitingInterceptorToChain.getVisitingInterceptor()) {
        }

        visitingInterceptorToChain.setVisitingInterceptor(interceptor);
    }

    public static abstract class VisitingInterceptor {
        private VisitingInterceptor visitingInterceptor;
         ...
         * @return
         */
        public abstract Object intercept(ParseTree tree, Function<ParseTree, Object> c);

        /**
         * to continue intercepting
         *
         * @param tree the node to visit
         * @param c the actual visiting
         * @return the result of intercepting
         */
        protected final Object chain(final ParseTree tree, final Function<ParseTree, Object> c) {
            if (null == visitingInterceptor) {
                return c.apply(tree);
            }

            return visitingInterceptor.intercept(tree, c);
        }

        public VisitingInterceptor getVisitingInterceptor() {
            return this.visitingInterceptor;
        }

        public void setVisitingInterceptor(VisitingInterceptor visitingInterceptor) {
            this.visitingInterceptor = visitingInterceptor;
        }
    }
